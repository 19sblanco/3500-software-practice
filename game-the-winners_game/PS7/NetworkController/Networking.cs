...
{
    /// <summary>
    /// A Networking Library that allows you to connect multiple clients to a server and reach servers through a DNS.
    /// </summary>
    public static class Networking
    {
        ...
        public static TcpListener StartServer(Action<SocketState> toCall, int port)
        {
            ...
            {
                ErrorOccurred(toCall, "Unable to accept new client");
            }
        ...
        {
            var tuple = ((Action<SocketState>, TcpListener))(ar.AsyncState);
        ...
        public static void ConnectToServer(Action<SocketState> toCall, string hostName, int port)
        {
            ...
            try
            {
                ...
                if (!foundIPV4)
                {
                    ErrorOccurred(toCall, "Didn't find any IPV4 addresses");
                    return;
                }
            }
            catch (Exception)
            {
                ...
                {
                    ErrorOccurred(toCall, "Host Name wasn't valid.");
                    return;
                }
            }
            ...
            {
                ErrorOccurred(toCall, "Unable to Connect");
            }
        }
        ...
        private static void ReceiveCallback(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                if (numBytes == 0)
                {
                    ErrorOccurred(toCall, "Send unsuccessful");
                    return;
                }
                lock (state)
                {
        ...
        /// <summary>
        /// Creates state and set its errorOccured to true;
        /// </summary>
        /// <param name="toCall">Action being performed on the SocketState</param>
